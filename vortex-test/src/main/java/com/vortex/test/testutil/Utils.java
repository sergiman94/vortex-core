...
import com.vortex.test.testutil.FakeObjects.FakeEdge;
import com.vortex.test.testutil.FakeObjects.FakeVertex;
...
public class Utils {
    ...
    public static final String CONF_PATH = "vortex.properties";

    public static Vortex open() {
        ...
        return VortexFactory.open(confPath);
    }
    ...
    public static PropertiesConfiguration getConf() {
        ...
        try {
            ...
            throw new VortexException("Unable to load config file: %s",
                                    e, confFile);
        }
        return config;
    }
