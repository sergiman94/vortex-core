...
import com.vortex.vortexdb.backend.Transaction;
...
public abstract class AbstractTransaction implements Transaction {
    ...
    public AbstractTransaction(VortexParams graph, BackendStore store) {
    ...
    @Watched(prefix = "tx")
    public BackendEntry query(VortexType type, Id id) {
        IdQuery idQuery = new IdQuery.OneIdQuery(type, id);
        return this.query(idQuery).one();
    }

    public BackendEntry get(VortexType type, Id id) {
