...
import com.vortex.vortexdb.backend.LocalCounter;
...
public abstract class InMemoryDBStore
    ...
    private final Map<VortexType, InMemoryDBTable> tables;
    ...
    protected void registerTableManager(VortexType type, InMemoryDBTable table) {
    ...
    @Override
    protected final InMemoryDBTable table(VortexType type) {
        assert type != null;
    ...
    @Override
    protected BackendSession session(VortexType type) {
        return null;
    }
    ...
    public static class InMemorySchemaStore extends InMemoryDBStore {
        ...
        public InMemorySchemaStore(BackendStoreProvider provider,
            ...
            registerTableManager(VortexType.VERTEX_LABEL,
                                 new InMemoryDBTable(VortexType.VERTEX_LABEL));
            registerTableManager(VortexType.EDGE_LABEL,
                                 new InMemoryDBTable(VortexType.EDGE_LABEL));
            registerTableManager(VortexType.PROPERTY_KEY,
                                 new InMemoryDBTable(VortexType.PROPERTY_KEY));
            registerTableManager(VortexType.INDEX_LABEL,
                                 new InMemoryDBTable(VortexType.INDEX_LABEL));
    ...
    public static class InMemoryGraphStore extends InMemoryDBStore {
        ...
        public InMemoryGraphStore(BackendStoreProvider provider,
            ...
            registerTableManager(VortexType.EDGE_OUT,
                                 new InMemoryDBTables.Edge(VortexType.EDGE_OUT));
            registerTableManager(VortexType.EDGE_IN,
                                 new InMemoryDBTables.Edge(VortexType.EDGE_IN));
            registerTableManager(VortexType.SECONDARY_INDEX,
                                 new InMemoryDBTables.SecondaryIndex());
