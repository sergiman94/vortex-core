...
public abstract class Condition {
    ...
    public abstract boolean test(VortexElement element);
    ...
    public static Relation eq(VortexKeys key, Object value) {
        return new SyspropRelation(key, RelationType.EQ, value);
    }

    public static Relation gt(VortexKeys key, Object value) {
        return new SyspropRelation(key, RelationType.GT, value);
    }

    public static Relation gte(VortexKeys key, Object value) {
        return new SyspropRelation(key, RelationType.GTE, value);
    }

    public static Relation lt(VortexKeys key, Object value) {
        return new SyspropRelation(key, RelationType.LT, value);
    }

    public static Relation lte(VortexKeys key, Object value) {
        return new SyspropRelation(key, RelationType.LTE, value);
    }

    public static Relation neq(VortexKeys key, Object value) {
        return new SyspropRelation(key, RelationType.NEQ, value);
    }

    public static Condition in(VortexKeys key, List<?> value) {
        return new SyspropRelation(key, RelationType.IN, value);
    }

    public static Condition nin(VortexKeys key, List<?> value) {
        return new SyspropRelation(key, RelationType.NOT_IN, value);
    }

    public static Condition prefix(VortexKeys key, Id value) {
        return new SyspropRelation(key, RelationType.PREFIX, value);
    }

    public static Condition containsValue(VortexKeys key, Object value) {
        return new SyspropRelation(key, RelationType.CONTAINS_VALUE, value);
    }

    public static Condition containsKey(VortexKeys key, Object value) {
        return new SyspropRelation(key, RelationType.CONTAINS_KEY, value);
    }

    public static Condition contains(VortexKeys key, Object value) {
    ...
    public static Condition scan(String start, String end) {
        ...
        return new SyspropRelation(VortexKeys.ID, RelationType.SCAN, value);
    }
    ...
    public static class SyspropRelation extends Relation {
        ...
        private VortexKeys key;

        public SyspropRelation(VortexKeys key, Object value) {
            this(key, RelationType.EQ, value);
        }

        public SyspropRelation(VortexKeys key, RelationType op, Object value) {
    ...
    public static class UserpropRelation extends Relation {
        ...
        @Override
        public boolean test(VortexElement element) {
            VortexProperty<?> prop = element.getProperty(this.key);
