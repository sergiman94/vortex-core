...
public abstract class BackendEntryIterator implements CIter<com.vortex.vortexdb.backend.store.BackendEntry> {
    ...
    protected com.vortex.vortexdb.backend.store.BackendEntry current;
    private long count;
    ...
    @Override
    public com.vortex.vortexdb.backend.store.BackendEntry next() {
        ...
        com.vortex.vortexdb.backend.store.BackendEntry current = this.current;
        if (current == null) {
            throw new NoSuchElementException();
        }
    ...
    protected long sizeOf(com.vortex.vortexdb.backend.store.BackendEntry entry) {
        return 1;
    }

    protected long skip(com.vortex.vortexdb.backend.store.BackendEntry entry, long skip) {
