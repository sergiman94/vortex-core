...
import com.vortex.common.config.ConfigConvOption;
...
import static com.vortex.vortexdb.backend.transaction.GraphTransaction.COMMIT_BATCH;
...
public class CoreOptions extends OptionHolder {
    ...
    public static final ConfigOption<String> GREMLIN_GRAPH =
            new ConfigOption<>(
                    ...
                    disallowEmpty(),
                    "com.vortex.vortexdb.VortexFactory"
            );
