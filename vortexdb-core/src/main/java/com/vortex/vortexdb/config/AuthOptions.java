...
package com.vortex.vortexdb.config;
...
import static com.vortex.common.config.OptionChecker.rangeDouble;
import static com.vortex.common.config.OptionChecker.rangeInt;
    ...
    public static final ConfigOption<String> AUTHENTICATOR =
            new ConfigOption<>(
                    ...
                    "The class path of authenticator implemention. " +
                            "e.g., com.vortex.common.auth.StandardAuthenticator, " +
                            "or com.vortex.common.auth.ConfigAuthenticator.",
                    null,
                    ""
            );
    ...
    public static final ConfigOption<String> AUTH_GRAPH_STORE =
            new ConfigOption<>(
                    ...
                    "The name of graph used to store authentication information, " +
                            "like users, only for com.vortex.common.auth.StandardAuthenticator.",
                    disallowEmpty(),
                    "vortex"
            );
    ...
    public static final ConfigOption<String> AUTH_ADMIN_TOKEN =
            new ConfigOption<>(
                    ...
                    "Token for administrator operations, " +
                            "only for com.vortex.common.auth.ConfigAuthenticator.",
                    disallowEmpty(),
    ...
    public static final ConfigListOption<String> AUTH_USER_TOKENS =
            new ConfigListOption<>(
                    ...
                    "The map of user tokens with name and password, " +
                            "only for com.vortex.common.auth.ConfigAuthenticator.",
                    disallowEmpty(),
                    "vortex:9fd95c9c-711b-415b-b85f-d4df46ba5c31"
            );
