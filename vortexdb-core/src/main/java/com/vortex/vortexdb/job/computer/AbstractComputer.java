...
public abstract class AbstractComputer implements Computer {
    ...
    private static final String MAIN_COMMAND =
            "%s/bin/hadoop jar vortex-computer.jar " +
            "com.vortex.vortexdb.Computer " +
            "-D libjars=./vortex-computer-core.jar";
    ...
    public Object call(Job<Object> job, Map<String, Object> parameters) {
        ...
        try {
            ...
            throw new VortexException("The computer job exit with code %s: %s",
                                    exitCode, output);
        } catch (VortexException e) {
            throw e;
        } catch (Throwable e) {
            throw new VortexException("Failed to execute computer job", e);
        }
    }
    ...
    protected static long degree(Map<String, Object> parameters) {
        ...
        VortexTraverser.checkDegree(degree);
        return degree;
    }
