...
public final class Consumers<V> {
    ...
    public void await() throws Throwable {
        ...
        if (this.executor == null) {
            ...
            try {
                ...
                this.exception = new VortexException(error, e);
                LOG.warn(error, e);
            }
        }
    ...
    public static RuntimeException wrapException(Throwable e) {
        ...
        throw new VortexException("Error when running task: %s",
                                VortexException.rootCause(e).getMessage(), e);
    }
    ...
    public static class StopExecution extends VortexException {
