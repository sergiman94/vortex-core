...
import com.vortex.common.concurrent.KeyLock;
import com.vortex.common.concurrent.LockManager;
import com.vortex.common.concurrent.RowLock;
...
public final class LockUtil {
    ...
    public static String vortexType2Group(VortexType type) {
        switch (type) {
            case PROPERTY_KEY:
