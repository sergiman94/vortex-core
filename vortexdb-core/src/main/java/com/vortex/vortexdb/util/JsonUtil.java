...
import com.vortex.vortexdb.io.VortexSONModule;
...
public final class JsonUtil {
    ...
    static {
        ...
        VortexSONModule.registerCommonSerializers(module);
        VortexSONModule.registerIdSerializers(module);
        VortexSONModule.registerSchemaSerializers(module);
        VortexSONModule.registerGraphSerializers(module);
    ...
    public static String toJson(Object object) {
        try {
            ...
            throw new VortexException("Can't write json: %s", e, e.getMessage());
        }
    }
    ...
    public static <T> T fromJson(String json, Class<T> clazz) {
        ...
        try {
            ...
            throw new VortexException("Can't read json: %s", e, e.getMessage());
        }
    }
