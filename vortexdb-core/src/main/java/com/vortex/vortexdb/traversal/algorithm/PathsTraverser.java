...
import com.vortex.vortexdb.traversal.algorithm.records.PathsRecords;
...
public class PathsTraverser extends VortexTraverser {

    public PathsTraverser(Vortex graph) {
        super(graph);
    }
