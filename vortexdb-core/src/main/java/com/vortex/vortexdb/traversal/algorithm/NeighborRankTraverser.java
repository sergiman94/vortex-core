...
import com.vortex.common.util.OrderLimitMap;
...
public class NeighborRankTraverser extends VortexTraverser {
    ...
    public NeighborRankTraverser(Vortex graph, double alpha, long capacity) {
        super(graph);
