...
import com.vortex.vortexdb.traversal.algorithm.records.ShortestPathRecords;
...
public class ShortestPathTraverser extends VortexTraverser {

    public ShortestPathTraverser(Vortex graph) {
        super(graph);
    }
