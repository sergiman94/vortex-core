...
public class CustomizedCrosspointsTraverser extends VortexTraverser {

    public CustomizedCrosspointsTraverser(Vortex graph) {
        super(graph);
    }
    ...
    public CrosspointsPaths crosspointsPaths(Iterator<Vertex> vertices,
        ...
        List<VortexVertex> verticesList = newList();
    ...
    private static CrosspointsPaths intersectionPaths(List<VortexVertex> sources,
                                                      List<Path> paths,
                                                      long limit) {
        ...
        Set<Id> sourceIds = sources.stream().map(VortexVertex::id)
    ...
    public static class Step {
        ...
        public Step(Vortex g, Directions direction, List<String> labels,
