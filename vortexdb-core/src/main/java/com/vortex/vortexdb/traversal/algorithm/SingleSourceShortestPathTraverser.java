...
public class SingleSourceShortestPathTraverser extends VortexTraverser {

    public SingleSourceShortestPathTraverser(Vortex graph) {
        super(graph);
    }
    ...
    private class Traverser {
        ...
        private double edgeWeight(VortexEdge edge) {
            double edgeWeight;
            if (this.weight == null ||
