...
import com.vortex.vortexdb.backend.id.IdGenerator.LongId;
import com.vortex.vortexdb.backend.id.IdGenerator.StringId;
import com.vortex.vortexdb.backend.id.IdGenerator.UuidId;
...
import com.vortex.vortexdb.util.Blob;
...
public class VortexSONModule extends TinkerPopJacksonModule {

    private static final long serialVersionUID = 6480426922914059122L;

    private static final String TYPE_NAMESPACE = "vortexgraph";
    ...
    static {
        ...
        // VortexGraph vertex serializer
        TYPE_DEFINITIONS.put(VortexVertex.class, "VortexVertex");
        // TYPE_DEFINITIONS.put(VortexEdge.class, "VortexEdge");

        // VortexGraph shard serializer
        TYPE_DEFINITIONS.put(Shard.class, "Shard");
    }

    public static void register(VortexIoRegistry io) {
        io.register(GraphSONIo.class, null, new VortexSONModule());
    }

    private VortexSONModule() {
        ...
        // VortexGraph vertex/edge serializer
    ...
    public static void registerGraphSerializers(SimpleModule module) {
         ...
         */
        module.addSerializer(VortexVertex.class, new VortexVertexSerializer());
        module.addSerializer(VortexEdge.class, new VortexEdgeSerializer());
    ...
    protected static abstract class VortexElementSerializer<T extends VortexElement>
                              extends StdSerializer<T> {

        public VortexElementSerializer(Class<T> clazz) {
            super(clazz);
        }
        ...
        public void writePropertiesField(Collection<VortexProperty<?>> properties,
                                         JsonGenerator generator,
                                         SerializerProvider provider)
                                         throws IOException {
            ...
            for (VortexProperty<?> property : properties) {
    ...
    private static class VortexVertexSerializer
                   extends VortexElementSerializer<VortexVertex> {

        public VortexVertexSerializer() {
            super(VortexVertex.class);
        }

        @Override
        public void serialize(VortexVertex vertex, JsonGenerator generator,
                              SerializerProvider provider)
                              throws IOException {
            vertex.forceLoad();
            generator.writeStartObject();
        ...
        @Override
        public void serializeWithType(VortexVertex value, JsonGenerator generator,
                                      SerializerProvider provider,
                                      TypeSerializer typeSer)
                                      throws IOException {
            WritableTypeId typeId = typeSer.typeId(value, JsonToken.VALUE_STRING);
    ...
    private static class VortexEdgeSerializer
                   extends VortexElementSerializer<VortexEdge> {

        public VortexEdgeSerializer() {
            super(VortexEdge.class);
        }

        @Override
        public void serialize(VortexEdge edge, JsonGenerator generator,
                              SerializerProvider provider)
                              throws IOException {
            edge.forceLoad();
            generator.writeStartObject();
            ...
            VortexVertex outVertex = (VortexVertex) edge.outVertex();
            VortexVertex inVertex = (VortexVertex) edge.inVertex();
        ...
        @Override
        public void serializeWithType(VortexEdge value, JsonGenerator generator,
                                      SerializerProvider provider,
                                      TypeSerializer typeSer)
                                      throws IOException {
            WritableTypeId typeId = typeSer.typeId(value, JsonToken.VALUE_STRING);
