...
package com.vortex.vortexdb.security;
...
public class VortexSecurityManager extends SecurityManager {

    private static final String USER_DIR = System.getProperty("user.dir");

    private static final String USER_DIR_IDE =
                                USER_DIR.endsWith("vortex-dist") ?
    ...
    private static final Map<String, Set<String>> BACKEND_THREAD = ImmutableMap.of(
            // Fixed #758
            "com.vortex.vortexdb.backend.store.cassandra.CassandraStore",
    ...
    private static final Map<String, Set<String>> BACKEND_SNAPSHOT = ImmutableMap.of(
            "com.vortex.vortexdb.backend.store.AbstractBackendStoreProvider",
            ImmutableSet.of("createSnapshot", "resumeSnapshot"),
            "com.vortex.vortexdb.backend.store.raft.RaftBackendStoreProvider",
            ImmutableSet.of("createSnapshot", "resumeSnapshot")
    );

    private static final Set<String> HBASE_CLASSES = ImmutableSet.of(
            // Fixed #758
            "com.vortex.vortexdb.backend.store.hbase.HbaseStore",
            "com.vortex.vortexdb.backend.store.hbase.HbaseStore$HbaseSchemaStore",
            "com.vortex.vortexdb.backend.store.hbase.HbaseStore$HbaseGraphStore",
            "com.vortex.vortexdb.backend.store.hbase.HbaseSessions$RowIterator"
    );

    private static final Set<String> RAFT_CLASSES = ImmutableSet.of(
            "com.vortex.vortexdb.backend.store.raft.RaftNode",
            "com.vortex.vortexdb.backend.store.raft.StoreStateMachine",
            "com.vortex.vortexdb.backend.store.raft.rpc.RpcForwarder"
    );
    ...
    private static final Map<String, Set<String>> NEW_SECURITY_EXCEPTION = ImmutableMap.of(
            "com.vortex.vortexdb.security.VortexSecurityManager",
    ...
    private static SecurityException newSecurityException(String message,
         ...
         * initialized: the logger is not initialized when VortexSecurityManager
         * class is loaded
         */
        Logger log = Log.logger(VortexSecurityManager.class);
    ...
    private static boolean callFromEventHubNotify() {
        ...
        return callFromMethod("com.vortex.common.event.EventHub", "notify");
    }
