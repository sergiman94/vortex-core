...
import com.vortex.vortexdb.type.define.AggregateType;
...
import com.vortex.common.util.LongEncoding;
...
public class PropertyKey extends SchemaElement implements Propfiable {
    ...
    public PropertyKey(final Vortex graph, Id id, String name) {
        super(graph, id, name);
    ...
    public VortexType type() {
        return VortexType.PROPERTY_KEY;
    }
    ...
    public <T> T newValue() {
        ...
        try {
            ...
            throw new VortexException("Failed to new instance of %s: %s",
