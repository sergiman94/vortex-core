...
public class IndexLabel extends SchemaElement {
    ...
    private VortexType baseType;
    private Id baseValue;
    private IndexType indexType;
    private List<Id> indexFields;

    public IndexLabel(final Vortex graph, Id id, String name) {
        super(graph, id, name);
        this.baseType = VortexType.SYS_SCHEMA;
    ...
    public void baseType(VortexType baseType) {
    ...
    public VortexType queryType() {
        switch (this.baseType) {
            case VERTEX_LABEL:
                return VortexType.VERTEX;
            case EDGE_LABEL:
                return VortexType.EDGE;
            case SYS_SCHEMA:
                return VortexType.SYS_SCHEMA;
            default:
                throw new AssertionError(String.format(
                          "Query type of index label is either '%s' or '%s', " +
                          "but '%s' is used",
                          VortexType.VERTEX_LABEL, VortexType.EDGE_LABEL,
                          this.baseType));
        }
    }
    ...
    public static IndexLabel label(VortexType type) {
        switch (type) {
            case VERTEX:
                return VL_IL;
            case EDGE:
    ...
    public static IndexLabel label(Vortex graph, Id id) {
    ...
    public static SchemaLabel getElement(Vortex graph,
                                         VortexType baseType, Object baseValue) {
    ...
    public interface Builder extends SchemaBuilder<IndexLabel> {
        ...
        Builder on(VortexType baseType, String baseValue);
