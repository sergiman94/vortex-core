...
public class IndexLabelBuilder extends AbstractBuilder
    ...
    public IndexLabel build() {
        Id id = this.validOrGenerateId(VortexType.INDEX_LABEL,
                                       this.id, this.name);
        this.checkBaseType();
        this.checkIndexType();
    ...
    private boolean hasSameProperties(IndexLabel existedIndexLabel) {
        // baseType is null, it means VortexType.SYS_SCHEMA
        if ((this.baseType == null &&
             existedIndexLabel.baseType() != VortexType.SYS_SCHEMA) ||
            (this.baseType != null &&
    ...
    public SchemaElement.TaskWithSchema createWithTask() {
        VortexType type = VortexType.INDEX_LABEL;
    ...
    public IndexLabelBuilder onV(String baseValue) {
        this.baseType = VortexType.VERTEX_LABEL;
    ...
    @Override
    public IndexLabelBuilder on(VortexType baseType, String baseValue) {
        E.checkArgument(baseType == VortexType.VERTEX_LABEL ||
                        baseType == VortexType.EDGE_LABEL,
