...
import com.vortex.backend.store.cassandra.CassandraTables.Edge;
import com.vortex.backend.store.cassandra.CassandraTables.Vertex;
...
import com.vortex.common.util.UnitUtil;
...
public class CassandraMetrics implements BackendMetrics {
    ...
    public CassandraMetrics(VortexConfig conf,
        ...
        this.port = conf.get(com.vortex.backend.store.cassandra.CassandraOptions.CASSANDRA_JMX_PORT);
        this.username = conf.get(com.vortex.backend.store.cassandra.CassandraOptions.CASSANDRA_USERNAME);
        this.password = conf.get(com.vortex.backend.store.cassandra.CassandraOptions.CASSANDRA_PASSWORD);
