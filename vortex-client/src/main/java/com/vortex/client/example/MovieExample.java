...
////              .range().ifNotExist().create();
        ...
        Vertex theMatrix = graph.addVertex(T.label, "movie", "title", "The Matrix", "released", Integer.parseInt("1999"));
        Vertex keanu = graph.addVertex(T.label, "person", "name", "keanu Reeves", "born", Integer.parseInt("1999"));
        Vertex carrie = graph.addVertex(T.label, "person", "name", "carrie-anne Moss", "born", Integer.parseInt("1967"));
        Vertex laurence = graph.addVertex(T.label, "person", "name", "laurence Fishburne", "born", Integer.parseInt("1961"));
        Vertex hugo = graph.addVertex(T.label, "person", "name", "hugo Weaving", "born", Integer.parseInt("1960"));
        Vertex lillyW = graph.addVertex(T.label, "person", "name", "Lilly Wachowski", "born", Integer.parseInt("1967"));
        Vertex lanaW = graph.addVertex(T.label, "person", "name", "Lana Wachowski", "born", Integer.parseInt("1965"));
        Vertex joelS = graph.addVertex(T.label, "person", "name", "Joel Silver", "born", Integer.parseInt("1952"));
        ...
        lillyW.addEdge("DIRECTED", theMatrix, "score", Integer.parseInt("10"));
        lanaW.addEdge("DIRECTED", theMatrix, "score", Integer.parseInt("10"));
        joelS.addEdge("PRODUCED", theMatrix, "score", Integer.parseInt("10"));

        Vertex emil = graph.addVertex(T.label, "person", "name", "emil Eifrem", "born", Integer.parseInt("1978"));
        emil.addEdge("ACTED_IN", theMatrix, "roles", "emil");

        Vertex theMatrixReloaded = graph.addVertex(T.label, "movie", "title", "The Matrix Reloaded", "released", Integer.parseInt("2003"));
        ...
        lillyW.addEdge("DIRECTED", theMatrixReloaded, "score", Integer.parseInt("10"));
        lanaW.addEdge("DIRECTED", theMatrix, "score", Integer.parseInt("10"));
        joelS.addEdge("PRODUCED", theMatrixReloaded, "score", Integer.parseInt("10"));

        Vertex theMatrixRevolutions = graph.addVertex(T.label, "movie", "title", "The Matrix Revolutions", "released", Integer.parseInt("2003"));
        ...
        lillyW.addEdge("DIRECTED", theMatrixRevolutions, "score", Integer.parseInt("10"));
        lanaW.addEdge("DIRECTED", theMatrixRevolutions, "score", Integer.parseInt("10"));
        joelS.addEdge("PRODUCED", theMatrixRevolutions, "score", Integer.parseInt("10"));

        Vertex theDevilsadvocate = graph.addVertex(T.label, "movie", "title", "The Devil's advocate", "released", Integer.parseInt("1997"));

        Vertex charlize = graph.addVertex(T.label, "person", "name", "charlize Theron", "born", Integer.parseInt("1975"));
        Vertex al = graph.addVertex(T.label, "person", "name", "al Pacino", "born", Integer.parseInt("1940"));
        Vertex taylor = graph.addVertex(T.label, "person", "name", "taylor Hackford", "born", Integer.parseInt("1944"));
        ...
        taylor.addEdge("DIRECTED", theDevilsadvocate, "score", Integer.parseInt("10"));

        Vertex aFewGoodMen = graph.addVertex(T.label, "movie", "title", "a Few Good Men", "released", Integer.parseInt("1992"));

        Vertex tomC = graph.addVertex(T.label, "person", "name", "Tom Cruise", "born", Integer.parseInt("1962"));
        Vertex jackN = graph.addVertex(T.label, "person", "name", "Jack Nicholson", "born", Integer.parseInt("1937"));
        Vertex demiM = graph.addVertex(T.label, "person", "name", "Demi Moore", "born", Integer.parseInt("1962"));
        Vertex kevinB = graph.addVertex(T.label, "person", "name", "Kevin Bacon", "born", Integer.parseInt("1958"));
        Vertex kieferS = graph.addVertex(T.label, "person", "name", "Kiefer Sutherland", "born", Integer.parseInt("1966"));
        Vertex noahW = graph.addVertex(T.label, "person", "name", "Noah Wyle", "born", Integer.parseInt("1971"));
        Vertex cubaG = graph.addVertex(T.label, "person", "name", "Cuba Gooding Jr.", "born", Integer.parseInt("1968"));
        Vertex kevinP = graph.addVertex(T.label, "person", "name", "Kevin Pollak", "born", Integer.parseInt("1957"));
        Vertex jtw = graph.addVertex(T.label, "person", "name", "J.T. Walsh", "born", Integer.parseInt("1943"));
        Vertex jamesM = graph.addVertex(T.label, "person", "name", "James Marshall", "born", Integer.parseInt("1967"));
        Vertex christopherG = graph.addVertex(T.label, "person", "name", "Christopher Guest", "born", Integer.parseInt("1948"));
        Vertex robR = graph.addVertex(T.label, "person", "name", "Rob Reiner", "born", Integer.parseInt("1947"));
        Vertex aaronS = graph.addVertex(T.label, "person", "name", "aaron Sorkin", "born", Integer.parseInt("1961"));
        ...
        robR.addEdge("DIRECTED", aFewGoodMen, "score", Integer.parseInt("10"));
        aaronS.addEdge("WROTE", aFewGoodMen, "score", Integer.parseInt("10"));

        Vertex topGun = graph.addVertex(T.label, "movie", "title", "Top Gun", "released", Integer.parseInt("1986"));

        Vertex kellyM = graph.addVertex(T.label, "person", "name", "Kelly McGillis", "born", Integer.parseInt("1957"));
        Vertex valK = graph.addVertex(T.label, "person", "name", "Val Kilmer", "born", Integer.parseInt("1959"));
        Vertex anthonyE = graph.addVertex(T.label, "person", "name", "anthony Edwards", "born", Integer.parseInt("1962"));
        Vertex tomS = graph.addVertex(T.label, "person", "name", "Tom Skerritt", "born", Integer.parseInt("1933"));
        Vertex megR = graph.addVertex(T.label, "person", "name", "Meg Ryan", "born", Integer.parseInt("1923"));
        Vertex tonyS = graph.addVertex(T.label, "person", "name", "Tony Scott", "born", Integer.parseInt("1961"));
        Vertex jimC = graph.addVertex(T.label, "person", "name", "Jim Cash", "born", Integer.parseInt("1941"));
        ...
        Vertex jerryMaguire = graph.addVertex(T.label, "movie", "title", "Jerry Maguire", "released", Integer.parseInt("2000"));

        Vertex reneeZ = graph.addVertex(T.label, "person", "name", "Renee Zellweger", "born", Integer.parseInt("1969"));
        Vertex kellyP = graph.addVertex(T.label, "person", "name", "Kelly Preston", "born", Integer.parseInt("1962"));
        Vertex jerryO = graph.addVertex(T.label, "person", "name", "Jerry O'Connell", "born", Integer.parseInt("1974"));
        Vertex jayM = graph.addVertex(T.label, "person", "name", "Jay Mohr", "born", Integer.parseInt("1970"));
        Vertex bonnieH = graph.addVertex(T.label, "person", "name", "Bonnie Hunt", "born", Integer.parseInt("1970"));
        Vertex reginaK = graph.addVertex(T.label, "person", "name", "Regina King", "born", Integer.parseInt("1961"));
        Vertex jonathanL = graph.addVertex(T.label, "person", "name", "Jonathan Lipnicki", "born", Integer.parseInt("1996"));
        Vertex cameronC = graph.addVertex(T.label, "person", "name", "Cameron Crowe", "born", Integer.parseInt("1957"));
        ...
        cameronC.addEdge("DIRECTED", jerryMaguire, "score", Integer.parseInt("10"));
        cameronC.addEdge("PRODUCED", jerryMaguire, "score",  Integer.parseInt("10"));
        cameronC.addEdge("WROTE", jerryMaguire, "score",  Integer.parseInt("10"));
