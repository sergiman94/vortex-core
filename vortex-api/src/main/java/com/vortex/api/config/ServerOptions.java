...
public class ServerOptions extends OptionHolder {
    ...
    public static final ConfigOption<String> REST_SERVER_URL =
            new ConfigOption<>(
                    "restserver.url",
                    "The url for listening of vortex-server.",
                    disallowEmpty(),
                    "http://127.0.0.1:8080"
            );
    ...
    public static final ConfigOption<String> AUTHENTICATOR =
            new ConfigOption<>(
                    ...
                    "e.g., com.vortex.api.auth.StandardAuthenticator, " +
                    "or com.vortex.api.auth.ConfigAuthenticator.",
                    null,
                    ""
            );
    ...
    public static final ConfigOption<String> AUTH_GRAPH_STORE =
            new ConfigOption<>(
                    ...
                    "like users, only for com.vortex.api.auth.StandardAuthenticator.",
                    disallowEmpty(),
                    "vortex"
            );
    ...
    public static final ConfigOption<String> AUTH_ADMIN_TOKEN =
            new ConfigOption<>(
                    ...
                    "only for com.vortex.api.auth.ConfigAuthenticator.",
                    disallowEmpty(),
